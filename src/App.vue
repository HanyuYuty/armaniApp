...
/> -->
        ...
        <!-- 底部导航 -->
    <van-tabbar v-model="active" active-color="#fff" inactive-color="rgb(112, 112, 112)" fixed z-index="100" >
      ...
      <van-tabbar-item icon="apps-o" size="25" to="/goods" color="black">全部商品</van-tabbar-item>
      <van-tabbar-item size="25">
           <span>独家臻礼</span>
        <template #icon>
